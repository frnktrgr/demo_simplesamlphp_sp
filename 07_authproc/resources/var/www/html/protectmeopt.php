...
<body>
<div class="m-5">
    <h1>Einfache Absicherung optional (keine eigene Session)</h1>
    <a href="<?php echo $as->getLoginURL()?>" class="btn btn-primary mb-2">Anmelden via Login URL</a>
    <a href="/logout.php" class="btn btn-danger mb-2">Abmelden via API</a>
    <a href="<?php echo $as->getLogoutURL('https://sso-dev.fau.de/protectmeopt.php')?>" class="btn btn-danger mb-2">Abmelden via Logout URL</a>
    <div>
